...
previos_step_coords=gr.Point(400, 700)
...
def lam_x(point_1, point_2):
    new_point = gr.Point(point_1.x + point_2.x,
                         point_1.y + point_2.y)
    x=point_2.x
    y=point_2.y
    return x
def lam_y(point_1, point_2):
    new_point = gr.Point(point_1.x + point_2.x,
                         point_1.y + point_2.y)
    x=point_2.x
    y=point_2.y
...
while True:
    ...
    x=lam_x(coords, velocity)
    y=lam_y(coords, velocity)
